...
print (df['qt_pessoas_residencia'].describe())
...
# O que se conclui, é que pessoas que tendem a permancer mais em um emprego têm taxas de inadipência menores. É importante observar, que desempregados ou pessoas que recentemente iniciaram um novo trabalho tem taxa de inadipêmcia menores que aqueles que tem de 1 à 4 anos de empresa. 
...
# Tarefa 04 resposta: Aumentando para o n_estimator para "15" não se conseguiu resultados significativamente melhores.
